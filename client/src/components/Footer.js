      ...
      <div className="h-[407px] w-full bg-gray-800 flex items-center justify-center text-white text-[13px] ">
        <div className="w-main flex ">
          <div className="flex-2 flex-col flex gap-2">
            ...
            <span>
              ...
              <span className="opacity-70">
                {" "}
                269 Nguyễn Thái Bình, Phường 4, Tân Bình
              </span>
            </span>
            <span>
              <span>Phone:</span>
          ...
          <div className="flex flex-1 flex-col gap-2">
            ...
            <span>Quảng Lưu, Quảng Xương, Thanh Hoá</span>
            <span>Quảng Thành, Thành phố Thanh Hoá</span>
            <span>Khu công nghiệp Nghi Sơn</span>
          </div>
        </div>
      </div>
    </div>
